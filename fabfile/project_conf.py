...
# Project name
fabconf['PROJECT_NAME'] = "jfoste.gq"
...
fabconf['EC2_KEY_NAME'] = "django-foster.pem"
...
fabconf['APPS_DIR'] = "/home/%s/sites" % fabconf['SERVER_USERNAME']

# Where you want your project installed: /APPS_DIR/PROJECT_NAME
fabconf[
    'PROJECT_PATH'] = "%s/%s" % (fabconf['APPS_DIR'], fabconf['PROJECT_NAME'])

# Your Django's version "run migrations" commands
fabconf['RUN_MIGRATIONS_STATIC'] = "python %s/manage.py collectstatic --noinput" % fabconf['PROJECT_PATH']
fabconf['RUN_MIGRATIONS_CMD'] = "python %s/manage.py migrate --noinput" % fabconf['PROJECT_PATH']

# App domains
fabconf['DOMAINS'] = "jfoste.gq www.jfoste.gq"

# Path for virtualenvs
fabconf['VIRTUALENV_DIR'] = "/home/%s/.virtualenvs" % fabconf['SERVER_USERNAME']

# Email for the server admin
fabconf['ADMIN_EMAIL'] = "lolimowizard@aol.com"

# Git username for the server
fabconf['GIT_USERNAME'] = "jamata"
...
# within a project)
fabconf['REPO_USERNAME'] = 'jamata'
fabconf['REPO_NAME'] = 'tdd-goat'
...
fabconf['INSTANCE_NAME_TAG'] = "django-foster"
...
fabconf['EC2_INSTANCES'] = ["ec2-34-226-196-38.compute-1.amazonaws.com"]
